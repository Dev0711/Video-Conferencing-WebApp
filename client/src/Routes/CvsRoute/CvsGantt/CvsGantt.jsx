...
export default function CvsGantt() {
    const taskValues = {
        id: 'TaskID',
        name: 'TaskName',
        startDate: 'StartDate',
    ...
    return (
        <div style={{ backgroundColor: '#fff7ed', margin: '20px', padding: '20px', borderRadius: '10px' }} className='w-[75rem]' >
