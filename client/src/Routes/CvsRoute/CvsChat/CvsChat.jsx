...
import CvsPoll from '../CvsPoll/CvsPoll';

export default function CvsChat() {
                ...
                <div className="flex flex-row h-full w-full overflow-x-hidden">
                    <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-blue-50 flex-shrink-0">
                        ...
                        >
                            ...
                            <div className="text-sm font-semibold mt-2">DoorDarshan</div>
                            <div className="text-xs text-gray-500">Web Development</div>
                            <div className="flex flex-row items-center mt-3">
                                <div
                                    className="flex flex-col justify-center h-4 w-8 bg-blue-400 rounded-full"
                                >
                    ...
                    <div className="flex flex-col flex-auto h-full p-6">
                        <div className="flex flex-col flex-auto flex-shrink-0 rounded-2xl bg-blue-100 h-full p-4">
                                        ...
                                        {messages.map((message, index) => (
                                            <div key={index} className={`col-start-1 col-end-13 p-3`}>
                                                <div className={`flex ${message.sender === "You" ? "flex-row-reverse" : "flex-row"} items-center`}>
                                                    ...
                                                    <div className={`relative ${message.sender === "You" ? "mr-3" : "ml-3"} text-sm bg-white py-2 px-4 shadow rounded-xl`}>
                            ...
                            <div className="chatbox-input flex" style={{ backgroundColor: '#fff', borderBottomRightRadius: '20px', borderTopRightRadius: '20px', borderRadius: 'none' }}>
                                <i className="fa-regular fa-face-grin" onClick={handlePollIconClick}></i>
                                <div style={{ display: 'flex', alignItems: 'center' }}>
                                    <label htmlFor="fileInput" style={{ cursor: 'pointer' }}>
                                        <i className="fa-sharp fa-solid fa-0" style={{ fontSize: '24px', color: '#333' }}></i>
                                    </label>
                                ...
                                <button style={{ marginLeft: '8px', background: '#38bbf6', color: '#fff', padding: '20px 12px', width: '100px', borderTopRightRadius: '20px', borderBottomRightRadius: '20px', cursor: 'pointer' }} onClick={handleSendMessage}>Send</button>
                            </div>
                            {showPoll && <CvsPoll onSubmit={handlePollSubmit} />}
                        </div>
                    </div>
                </div>
            </div>
